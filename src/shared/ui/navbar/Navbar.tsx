        ...
        <div>
          <ul className='navbarlist'>
            <div className="navbarButtons">
                ...
                {isProfileDropdownOpen && (
                  <div className="dropdown-content">
                    <NavLink to="/portfolio" to="/portfolio">
                         <button className="dropdown-item" >Портфоліо</button>
                    </NavLink>
                    <NavLink to="/personaldata" to="/personaldata">
                ...
                {isPersonalDataDropdownOpen && (
                  <div className="dropdown-content-second">
                    <NavLink to="/skills" to="/skills">
                        <button className="dropdown-item-second">Навички</button>
                    </NavLink>
                    <NavLink to="/specialization" to="/specialization">
            ...
            <li className="navbarlist-item">
              <NavLink to="/team" to="/team" className='navbarButton'>
              <img src={teamImg}/> <span className='navbaritem-desc'>Команда</span>
              </NavLink>
            </li>
            <li className="navbarlist-item">
              <NavLink to="/team" to="/projects" className='navbarButton'>
              <img src={lockImg}/> <span className='navbaritem-desc'>Проекти</span>
              </NavLink>
            </li>
            <li className="navbarlist-item ">
              <NavLink to="/team" to="/repository" className='navbarButton'>
